...
public class GuiScreenVoiceChatOptions extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.voiceVolume = new GuiBoostSlider(910, centerW + 2, centerH - 25 - 55, "", I18n.format("menu.worldVolume") + ": " + (this.voiceChat.getSettings().worldVolume == 0.0F ? I18n.format("options.off") : (int) (this.voiceChat.getSettings().worldVolume * 100.0F) + "%"), 0.0F);
        this.voiceVolume.sliderValue = this.voiceChat.getSettings().worldVolume / 2;
    ...
    public void updateScreen() {
        ...
        this.voiceChat.getSettings().setWorldVolume(this.voiceVolume.sliderValue * 2);
